<?php 
    ...
    if (isset($_POST['sbm'])){
        ...
        $sql_update = "UPDATE product SET prd_name='$prd_name', prd_image='$prd_image', cat_id=$cat_id, prd_status=$prd_status, prd_featured=$prd_featured WHERE prd_id=$prd_id";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="prd_status" class="form-control">
                                            <option <?php if($row['prd_status']==1){echo "selected";} ?> value=1>Đã duyệt</option>
                                            <option <?php if($row['prd_status']==0){echo "selected";} ?> value=0>Chờ duyệt</option>
                                        </select>
                                    </div>
