...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 20, 2022 lúc 02:53 PM
...
(41, 24, 940000, '2022-06-20', 'Đang chờ xử lý'),
...
(46, 24, 350000, '2022-06-20', 'Đang chờ xử lý'),
...
(24, 'admin', '$2y$10$Rw/UN3M6sQh/KDTgt07zeuopjgAczJlmQYg.3zhItNU2xJ7nBMQeu', 'WIN_20210926_20_20_56_Pro (2).jpg', 'admin@gmail.com', 2),
...
--
ALTER TABLE `comments`
  MODIFY `cmt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `order_detail`
  MODIFY `orderdt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `users_detail`
  MODIFY `userdt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
COMMIT;
